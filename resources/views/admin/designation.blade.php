...
@section('appContent')
    ...
    <section class="row content-wrap ">
        <div class="col-sm-8 col-12">
            <h4 class="text-uppercase"><span class="text-info">Designation</span></h4>
        </div>
    </section>
        ...
        <form class="col-12" id="frm_data">
             <div class="form-row">
                 <div class="col-6 form-group">
                    <label for="input_name">Designation</label>
...
$('#btn_save').click(function(){
    ...
    if(proceed) {       
        ...
        $.ajax({
            url:  window.BASE_URL + "/designation/ajax-update-designation",
            data: m_data,
            processData: false,
            contentType: false,
            type: 'POST',
